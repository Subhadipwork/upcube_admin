                ...
                @endif
                  ...
                  {{-- flash massage end --}}
                        ...
                        <form action="{{ route('subcategory.store') }}" method="POST" id="form_id" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                <label for="subcategory_image" class="col-sm-2 col-form-label">Upload Subcategory Image</label>
                                <div class="col-sm-10">
                                    <input class="form-control @error('image') is-invalid @enderror" type="file" name="image" id="subcategory_image" placeholder="Subcategory Image" onchange="previewImage(event)">
