            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('banner.create') }}" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;">
                        ...
                        @if ($banners->isNotEmpty())
                            @foreach ($banners as $banner)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('/uploaded/banner_images/'.$banner->image) }}" width="100px" height="100px" alt=""></td>
                                    <td>
